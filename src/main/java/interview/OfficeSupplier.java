...
public class OfficeSupplier {
    ...
    /*
     * The stapleToBeginning() method takes a String s, a char c, and returns a new
     * String.
     * The resulting String should have the character added to the front of the
     * original
     * - ex: "ey can I pull you for a chat?", 'H' ->
     * "Hey can I pull you for a chat?"
     */
    ...
    /*
     * The stapleToEnd() method takes a String s, a char c, and returns a new
     * String.
     * The resulting String should have the character added to the end of the
     * original
     * - ex: "Hey can I pull you for a cha?", 't' ->
     * "Hey can I pull you for a chat?"
     */
