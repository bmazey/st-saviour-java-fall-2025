...
public class ArrayerTest {
    ...
    public void testFindGreatest() {
        int[] first = {-1, 0, 4, 5, 13};
        assert Arrayer.findGreatest(first) == 13;

        int[] second = {0, 14, 5, 6, -3, 7};
        assert Arrayer.findGreatest(second) == 14;
    }
    ...
    public void testMerge() {
        ...
        // Your test should assert content, position, & length of the result.
    }
}
